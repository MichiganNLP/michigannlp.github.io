...
function showPublication(publication,includeDownloadLink) {
    ...
    if(publication.link || publication.demo || publication.data || publication.software) {
        ...
        if(publication.abstract) {
            entry = entry + '<a id="link-no-underline" data-toggle="collapse" data-parent="#accordion" href="#' + publication.id + '_abstract">abstract</a>';
            if(publication.bibtex) {
                entry = entry + ', ';
            }
        }
        if(publication.bibtex) {
            entry = entry + '<a id="link-no-underline" data-toggle="collapse" data-parent="#accordion" href="#' + publication.id + '_bibtex">BibTeX</a>';
        }
        entry = entry + ')';
    }
