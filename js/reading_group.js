...
function processReadingGroup(allText,pageCategory) {
    ...
    for(var i=0; i<semesters.length; ++i) {
        ...
        var entry = '<table id="reading-group-table"><tbody id="reading-group-tbody"><tr><th id="col1" class><p class="lead"><b>Date / Time</b></p></th><th id="colTopic" class="centered"><p class="lead"><b>Topic</b></p></th><th id="col2" class="centered"><p class="lead"><b>Facilitator</b></p></th><th id="col3_topic" class="centered"><p class="lead"><b>Paper</b></p></th><th id="col4" class="centered"><p class="lead"><b>Location</b></p></th></tr>'
